...
const businessIdeas = [
  ...
  {
    id: 29,
    title: "Специализированный ремонт микроэлектроники и гаджетов",
    description: "Восстановление сложной электроники, квадрокоптеров и носимых устройств. В 2025 ремонт — самая массовая ниша у самозанятых (7% рынка).",
    category: "Услуги B2C",
    recommendedForms: [
      { form: "НПД", confidence: 95, reason: "Идеально для мастера-одиночки" },
      { form: "ИП", confidence: 70, reason: "При открытии полноценного сервис-центра" },
    ],
    trend: "🛠️ Точечный ремонт",
    averageRevenue: "100K—300K ₽/мес",
  },
  {
    id: 30,
    title: "Автоняня и безопасное сопровождение детей",
    description: "Услуги по перевозке детей в школу и на секции на личном авто с фотоотчетами. Авто-услуги занимают 6.5% рынка самозанятости.",
    category: "Услуги B2C",
    recommendedForms: [
      { form: "НПД", confidence: 90, reason: "Простой старт для водителя" },
      { form: "ИП", confidence: 60, reason: "Для создания парка спец-авто" },
    ],
    trend: "🚗 Семейные сервисы",
    averageRevenue: "80K—200K ₽/мес",
  },
  {
    id: 31,
    title: "Консалтинг по внедрению нейросетей в бизнес",
    description: "Обучение сотрудников использованию AI для текстов, дизайна и аналитики. Информационные услуги — растущий тренд 2025 года.",
    category: "B2B Консалтинг",
    recommendedForms: [
      { form: "НПД", confidence: 85, reason: "Для частного эксперта" },
      { form: "ИП", confidence: 90, reason: "Для агентства по цифровой трансформации" },
    ],
    trend: "🧠 AI-адаптация",
    averageRevenue: "150K—500K ₽/мес",
  },
  {
    id: 32,
    title: "Мастерская кастомной мебели и реставрации",
    description: "Создание уникальных предметов интерьера или вдохновение новой жизни в старую мебель. Ниша 'Сделай сам' (DIY) активно растет.",
    category: "Производство",
    recommendedForms: [
      { form: "НПД", confidence: 80, reason: "Для ремесленной деятельности" },
      { form: "ИП", confidence: 85, reason: "При закупке дорогого оборудования и материалов" },
    ],
    trend: "🪑 Индивидуальный дизайн",
    averageRevenue: "120K—400K ₽/мес",
  },
  {
    id: 33,
    title: "Аренда и настройка оборудования для стриминга",
    description: "Сдача в аренду камер, света и звука для контент-мейкеров. Аренда и информационные услуги входят в топ-10 популярных сфер.",
    category: "Rent",
    recommendedForms: [
      { form: "НПД", confidence: 75, reason: "При доходе до 2.4 млн в год" },
      { form: "ИП", confidence: 90, reason: "При большом парке техники" },
    ],
    trend: "📸 Творческая экономика",
    averageRevenue: "100K—350K ₽/мес",
  },
  {
    id: 34,
    title: "Репетитор по профориентации и Soft Skills",
    description: "Помощь подросткам в выборе профессии и развитии навыков общения/лидерства. Обучение — стабильная ниша (2% самозанятых).",
    category: "Education",
    recommendedForms: [
      { form: "НПД", confidence: 95, reason: "Классическая форма для репетиторства" },
      { form: "ИП", confidence: 70, reason: "При создании образовательного центра" },
    ],
    trend: "🎓 Навыки будущего",
    averageRevenue: "90K—250K ₽/мес",
  },
  {
    id: 35,
    title: "Фуд-флористика: съедобные букеты и наборы",
    description: "Создание креативных подарков из фруктов, ягод и деликатесов. Сочетание категорий 'Торговля' и 'Общепит'.",
    category: "E-commerce",
    recommendedForms: [
      { form: "НПД", confidence: 85, reason: "Для домашнего кондитера/флориста" },
      { form: "ИП", confidence: 80, reason: "При открытии офлайн-точки" },
    ],
    trend: "🍓 Эстетичные подарки",
    averageRevenue: "70K—220K ₽/мес",
  },
  {
    id: 36,
    title: "Зоопсихолог и онлайн-коррекция поведения питомцев",
    description: "Консультации для владельцев животных по воспитанию и психологии. Услуги для животных — молодая, но перспективная ниша.",
    category: "Услуги B2C",
    recommendedForms: [
      { form: "НПД", confidence: 90, reason: "Для частных консультаций" },
      { form: "ИП", confidence: 60, reason: "Для ветеринарного кабинета" },
    ],
    trend: "🐾 Гуманное отношение",
    averageRevenue: "60K—180K ₽/мес",
  },
];
