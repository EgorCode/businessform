          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-muted-foreground" data-testid="text-ideas-subtitle">
                Рынок меняется. В 2026 году в тренде автоматизация, локальное производство и услуги для комфорта. Нажмите кнопку, чтобы получить случайную бизнес-идею, актуальную для России.
              </p>
            </div>
