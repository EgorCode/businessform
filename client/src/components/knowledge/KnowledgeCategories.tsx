...
Согласно Федеральному <a href="https://login.consultant.ru/link/?req=doc&base=LAW&n=520124&dst=100001%2C-1&date=22.01.2026&demo=2" target="_blank" class="text-primary hover:underline">закону</a> от 27.11.2018 № 422‑ФЗ, плательщиком НПД или "самозанятым" может стать:
...
Условия по Федеральныму <a href="https://login.consultant.ru/link/?req=doc&base=LAW&n=520124&dst=100001%2C-1&date=22.01.2026&demo=2" target="_blank" class="text-primary hover:underline">закону</a> от 27.11.2018 № 422‑ФЗ:
